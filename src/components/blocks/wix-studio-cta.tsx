      ...
      <div className="container">
        ...
        <div className="mt-10 flex flex-col items-center text-center lg:mt-24">
          <h2 className="text-2xl tracking-tight md:text-4xl lg:text-5xl">
            Have a Wix Studio project in mind?
          </h2>
          <p className="text-muted-foreground mt-4 max-w-xl leading-snug">
            Book a 30-minute call to talk through what you are building. Or send us a brief and we'll come back with a plan and a quote.
          </p>
