...
const steps = [
  { number: "01", title: "Discovery", line: "Learn your business and audit what exists." },
  { number: "02", title: "Design", line: "Wireframes and visuals before any code is written." },
  { number: "03", title: "Build", line: "Weekly updates in Webflow. No surprises at the end." },
  { number: "04", title: "Launch", line: "QA, SEO, analytics. Go live with confidence." },
      ...
      <div className="container">
        ...
        <div className="mx-auto mt-10 max-w-4xl text-center lg:mt-24">
          ...
          <p className="text-muted-foreground mx-auto mt-4 max-w-2xl leading-snug">
            From idea to launch — with no surprises.
          </p>
        </div>
