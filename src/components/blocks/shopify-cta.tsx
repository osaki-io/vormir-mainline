      ...
      <div className="container">
        ...
        <div className="mt-10 flex flex-col items-center text-center lg:mt-24">
          ...
          <p className="text-muted-foreground mt-4 max-w-xl leading-snug">
            Book a 30-minute call to talk through your store and goals. Or send us a project brief and we'll come back with a plan and a quote.
          </p>
