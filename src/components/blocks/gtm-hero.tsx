      ...
      <div className="container flex flex-col justify-between gap-8 md:gap-14 lg:flex-row lg:gap-20">
        ...
        <div className="flex-1">
          ...
          <div className="mb-6 flex items-center gap-1.5 text-sm text-muted-foreground">
            ...
            <span className="text-foreground">Go-to-Market Services</span>
          </div>

          <h1 className="text-foreground max-w-160 text-3xl tracking-tight md:text-4xl lg:text-5xl">
            GTM infrastructure that drives pipeline.
          </h1>

          <p className="text-muted-foreground text-1xl mt-5 md:text-2xl">
            Strategy, campaigns, automation, analytics, and content — built and run by one team so every channel connects back to revenue.
          </p>
